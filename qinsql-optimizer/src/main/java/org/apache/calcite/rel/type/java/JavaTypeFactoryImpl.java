 ...
 */
package org.apache.calcite.rel.type.java;
...
import org.apache.calcite.util.GeoFunctions;
import org.apache.calcite.util.Ord;
import org.apache.calcite.util.Pair;
import org.apache.calcite.util.Unit;
...
public class JavaTypeFactoryImpl extends SqlTypeFactoryImpl implements JavaTypeFactory {
     ...
     *
     * <p>Takes into account {@link org.apache.calcite.rel.type.annotations.Array}
     * annotations if present.
     */
    private Type fieldType(Field field) {
        final Class<?> klass = field.getType();
        final org.apache.calcite.rel.type.annotations.Array array = field
                .getAnnotation(org.apache.calcite.rel.type.annotations.Array.class);
        if (array != null) {
            return new Types.ArrayType(array.component(), array.componentIsNullable(), array.maximumCardinality());
        }
        final org.apache.calcite.rel.type.annotations.Map map = field
                .getAnnotation(org.apache.calcite.rel.type.annotations.Map.class);
        if (map != null) {
