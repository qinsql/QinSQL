...
import org.lealone.bats.api.Partitioner.PartitioningContext;
...
public class DefaultPartition<T> implements Partitioner.Partition<T>
{
  ...
  private final org.lealone.bats.api.Attribute.AttributeMap attributes = new DefaultAttributeMap();
  ...
  @Override
  public org.lealone.bats.api.Attribute.AttributeMap getAttributes()
  {
    return attributes;
  }
