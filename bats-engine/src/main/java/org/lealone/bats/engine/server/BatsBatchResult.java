...
public class BatsBatchResult implements Result {

    private final ArrayList<BatsResult> list = new ArrayList<>();
    private BatsResult current;

    int index;
    private int rowCount;

    void addBatsResult(BatsResult result) {
        list.add(result);
