...
create alias pg_convertType deterministic for "org.qinsql.postgresql.sql.PgAlias.convertType";

drop alias if exists pg_get_oid;
create alias pg_get_oid deterministic for "org.qinsql.postgresql.sql.PgAlias.getOid";
...
create alias pg_get_indexdef for "org.qinsql.postgresql.sql.PgAlias.getIndexColumn";

drop alias if exists version;
create alias version for "org.qinsql.postgresql.sql.PgAlias.getVersion";

drop alias if exists current_schema;
create alias current_schema for "org.qinsql.postgresql.sql.PgAlias.getCurrentSchema";
...
create alias pg_get_userbyid for "org.qinsql.postgresql.sql.PgAlias.getUserById";

drop alias if exists has_database_privilege;
create alias has_database_privilege for "org.qinsql.postgresql.sql.PgAlias.hasDatabasePrivilege";

drop alias if exists has_table_privilege;
create alias has_table_privilege for "org.qinsql.postgresql.sql.PgAlias.hasTablePrivilege";

drop alias if exists currtid2;
create alias currtid2 for "org.qinsql.postgresql.sql.PgAlias.getCurrentTid";
