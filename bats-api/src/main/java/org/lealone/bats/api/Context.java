...
import org.lealone.bats.api.StringCodec.Class2String;
import org.lealone.bats.api.StringCodec.Collection2String;
import org.lealone.bats.api.StringCodec.Integer2String;
import org.lealone.bats.api.StringCodec.JsonStringCodec;
import org.lealone.bats.api.StringCodec.Map2String;
import org.lealone.bats.api.StringCodec.Object2String;
import org.lealone.bats.api.StringCodec.String2String;
...
public interface Context
{
  ...
  interface PortContext extends Context
  {
     ...
     */
    Attribute<Class<?>> TUPLE_CLASS = new Attribute<Class<?>>(Class2String.getInstance());
  ...
  interface DAGContext extends Context
  {
     ...
     */
    Attribute<Map<Class<?>, Class<? extends StringCodec<?>>>> STRING_CODECS = new Attribute<Map<Class<?>, Class<? extends StringCodec<?>>>>(Map2String.getInstance(",", "=", Class2String.getInstance(), Class2String.<StringCodec<?>>getInstance()));
