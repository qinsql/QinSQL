...
class TypeConvertingSqlAccessor implements SqlAccessor {
     ...
     */
    private static SQLConversionOverflowException newOverflowException(String methodLabel, String valueTypeLabel,
            Object value) {
    ...
    public byte getByte(int rowOffset) throws InvalidAccessException {
        ...
        case SMALLINT:
            result = getByteValueOrThrow(innerAccessor.getShort(rowOffset), "Java short / SQL SMALLINT");
            break;
        case INT:
        ...
        case BIGINT:
            ...
            break;
        case FLOAT4:
            result = getByteValueOrThrow(innerAccessor.getFloat(rowOffset), "Java float / SQL REAL/FLOAT");
            break;
        case FLOAT8:
            result = getByteValueOrThrow(innerAccessor.getDouble(rowOffset), "Java double / SQL DOUBLE PRECISION");
            break;
        case VARDECIMAL:
            result = getByteValueOrThrow(innerAccessor.getBigDecimal(rowOffset).byteValue(),
    ...
    public short getShort(int rowOffset) throws InvalidAccessException {
        ...
        case BIGINT:
            ...
            break;
        case FLOAT4:
            result = getShortValueOrThrow(innerAccessor.getFloat(rowOffset), "Java float / SQL REAL/FLOAT");
            break;
        case FLOAT8:
            result = getShortValueOrThrow(innerAccessor.getDouble(rowOffset), "Java double / SQL DOUBLE PRECISION");
            break;
        case VARDECIMAL:
            result = getShortValueOrThrow(innerAccessor.getBigDecimal(rowOffset).shortValue(),
                    "Java BigDecimal / SQL DECIMAL PRECISION");
            break;
    ...
    public int getInt(int rowOffset) throws InvalidAccessException {
        ...
        case BIGINT:
            ...
            break;
        case FLOAT4:
            result = getIntValueOrThrow(innerAccessor.getFloat(rowOffset), "Java float / SQL REAL/FLOAT");
            break;
        case FLOAT8:
            result = getIntValueOrThrow(innerAccessor.getDouble(rowOffset), "Java double / SQL DOUBLE PRECISION");
            break;
        case VARDECIMAL:
            result = getIntValueOrThrow(innerAccessor.getBigDecimal(rowOffset).intValue(),
                    "Java BigDecimal / SQL DECIMAL PRECISION");
            break;
    ...
    public long getLong(int rowOffset) throws InvalidAccessException {
        ...
        case INT:
            ...
            break;
        case FLOAT4:
            result = getLongValueOrThrow(innerAccessor.getFloat(rowOffset), "Java float / SQL REAL/FLOAT");
            break;
        case FLOAT8:
            result = getLongValueOrThrow(innerAccessor.getDouble(rowOffset), "Java double / SQL DOUBLE PRECISION");
            break;
        case VARDECIMAL:
            result = getLongValueOrThrow(innerAccessor.getBigDecimal(rowOffset).longValue(),
                    "Java BigDecimal / SQL DECIMAL PRECISION");
            break;
    ...
    public float getFloat(int rowOffset) throws InvalidAccessException {
        ...
        case BIGINT:
            ...
            break;
        case FLOAT8:
            result = getFloatValueOrThrow(innerAccessor.getDouble(rowOffset), "Java double / SQL DOUBLE PRECISION");
            break;
        case VARDECIMAL:
            result = getFloatValueOrThrow(innerAccessor.getBigDecimal(rowOffset).floatValue(),
                    "Java BigDecimal / SQL DECIMAL PRECISION");
            break;
