...
public class LealoneRecordReader extends AbstractRecordReader {
    ...
    public LealoneRecordReader(ExecutorFragmentContext context, LealoneScanSpec scanSpec,
        ...
        QinClientConnection conn = (QinClientConnection) context.getUserDataTunnel().getConnection();
    ...
    public void setup(OperatorContext operatorContext, OutputMutator output)
        ...
        try {
            ...
            if (operatorContext.getFragmentContext() instanceof ExchangeFragmentContext) {
                QinClientConnection conn = (QinClientConnection) ((ExchangeFragmentContext) operatorContext
