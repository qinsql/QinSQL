 ...
 */
// 改编自org.h2.engine.Engine
public class BatsSessionFactory implements SessionFactory {

    private static final BatsSessionFactory INSTANCE = new BatsSessionFactory();
    ...
    public static BatsSessionFactory getInstance() {
        return INSTANCE;
    }
