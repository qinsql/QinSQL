...
import org.lealone.qinsql.engine.sql.QinQuery;
...
public class QinClientConnection implements org.apache.drill.exec.rpc.UserClientConnection {

    private final QinBatchResult batchResult = new QinBatchResult();
    ...
    public void sendData(RpcOutcomeListener<Ack> listener, RecordBatch data) {
        QinResult result = new QinResult(data);
        if (localResult == null) {
