...
create alias pg_convertType deterministic for "org.lealone.bats.postgresql.server.PgServer.convertType";

drop alias if exists pg_get_oid;
create alias pg_get_oid deterministic for "org.lealone.bats.postgresql.server.PgServer.getOid";
...
create alias pg_get_indexdef for "org.lealone.bats.postgresql.server.PgServer.getIndexColumn";

drop alias if exists version;
create alias version for "org.lealone.bats.postgresql.server.PgServer.getVersion";

drop alias if exists current_schema;
create alias current_schema for "org.lealone.bats.postgresql.server.PgServer.getCurrentSchema";

drop alias if exists pg_encoding_to_char;
create alias pg_encoding_to_char for "org.lealone.bats.postgresql.server.PgServer.getEncodingName";

drop alias if exists pg_postmaster_start_time;
create alias pg_postmaster_start_time for "org.lealone.bats.postgresql.server.PgServer.getStartTime";

drop alias if exists pg_get_userbyid;
create alias pg_get_userbyid for "org.lealone.bats.postgresql.server.PgServer.getUserById";

drop alias if exists has_database_privilege;
create alias has_database_privilege for "org.lealone.bats.postgresql.server.PgServer.hasDatabasePrivilege";

drop alias if exists has_table_privilege;
create alias has_table_privilege for "org.lealone.bats.postgresql.server.PgServer.hasTablePrivilege";

drop alias if exists currtid2;
create alias currtid2 for "org.lealone.bats.postgresql.server.PgServer.getCurrentTid";
